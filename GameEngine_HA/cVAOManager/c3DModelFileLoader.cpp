...
void cVAOManager::Load()
{
	...
	if (!saveFile.is_open())
	{
        ...
        g_pTheLightManager->vecTheLights[7].direction = glm::vec4(angles[0], 1.f);
        g_pTheLightManager->vecTheLights[8].direction = glm::vec4(angles[1], 1.f);
        g_pTheLightManager->vecTheLights[9].direction = glm::vec4(angles[2], 1.f);

        g_pTheLightManager->vecTheLights[10].direction = glm::vec4(angles[0], 1.f);
        g_pTheLightManager->vecTheLights[11].direction = glm::vec4(angles[1], 1.f);
        g_pTheLightManager->vecTheLights[12].direction = glm::vec4(angles[2], 1.f);

        g_pTheLightManager->vecTheLights[13].direction = glm::vec4(angles[0], 1.f);
        g_pTheLightManager->vecTheLights[14].direction = glm::vec4(angles[1], 1.f);
        g_pTheLightManager->vecTheLights[15].direction = glm::vec4(angles[2], 1.f);
